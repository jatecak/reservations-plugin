<div class="res-container res-thank-you">
	...
	<?php else: ?>
		...
		<?php if ($paid): ?>
			...
			<p class="res-spam-notice"><?php _e('If you don\'t receive the email, please check your SPAM folder.', 'reservations');?></p>
		...
		<?php elseif ($replacement): ?>
			...
			<p class="res-spam-notice"><?php _ex('If you don\'t receive the email, please check your SPAM folder.', 'future', 'reservations');?></p>
		<?php else: ?>
