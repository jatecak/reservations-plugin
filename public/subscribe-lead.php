<div class="res-container res-subscribe">
	...
	<form method="post">
		...
		<div class="res-field">
			<label><?php _e('Independent Leave', 'reservations');?></label>
			<select name="independent_leave">
				<?=$independentLeaveSelect?>
            </select>
		</div>
		...
		<p class="res-over-capacity res-hidden"><?php _e('This gym is full on the selected date. Please try a different one.', 'reservations');?></p>
