...
class TracyEloquentPanel implements IBarPanel
{
    private $count;
    private $data;
    private $time;
    ...
    public function getPanel()
    {
        ...
        return '<h1>Eloquent ORM</h1><div class="tracy-inner"><p><table width="100%">' . $this->data . '<tr class="yes"><th><b>' . $this->count . ' + ' . $this->wpdbCount . '</b></th><th><b>' . $this->time . ' ms</b></th><th>Total</th></tr></table></p></div>';
    }

    private function parse()
    {
        $data = Capsule::connection()->getQueryLog();
        ...
        $this->wpdbCount = get_num_queries();
    }
}
